...
class ExifToolMetadata(BaseModel):
    """ExifTool元数据模型"""
    # 基本文件信息
    exiftool_version: str = Field(alias="ExifToolVersion")
    ...
    file_permissions: int = Field(alias="FilePermissions")
    file_permissions_str: str = Field(alias="FilePermissionsStr")
    file_type: str = Field(alias="FileType")
    file_type_extension: str = Field(alias="FileTypeExtension")
    mime_type: str = Field(alias="MIMEType")

    # PE文件特定信息
    machine_type: str = Field(alias="MachineType")
    machine_type_description: str = Field(alias="MachineTypeDescription")
    time_stamp: Optional[datetime] = Field(None, alias="TimeStamp")
    image_file_characteristics: int = Field(alias="ImageFileCharacteristics")
    image_file_characteristics_description: List[str] = Field(alias="ImageFileCharacteristicsDescription")
    pe_type: int = Field(alias="PEType")
    pe_type_description: str = Field(alias="PETypeDescription")
    linker_version: str = Field(alias="LinkerVersion")
    code_size: int = Field(alias="CodeSize")
    initialized_data_size: int = Field(alias="InitializedDataSize")
    uninitialized_data_size: int = Field(alias="UninitializedDataSize")
    entry_point: str = Field(alias="EntryPoint")
    os_version: str = Field(alias="OSVersion")
    image_version: str = Field(alias="ImageVersion")
    subsystem_version: str = Field(alias="SubsystemVersion")
